...
export const RestaurantUpdateProfile = async (req, res, next) => {
  try {
    ...
    restaurantDataFromFE.contactDetails = {
      email: restaurantDataFromFE.contactEmail,
      phone: restaurantDataFromFE.contactPhone,
    };

    restaurantDataFromFE.servingHours = {
      openingTime: restaurantDataFromFE.openingTime,
      closingTime: restaurantDataFromFE.closingTime,
    };

    restaurantDataFromFE.geoLocation = {
      lat: restaurantDataFromFE.geoLat,
      lon: restaurantDataFromFE.geoLon,
    };

    restaurantDataFromFE.financialDetails = {
    ...
    restaurantDataFromFE.documents = {
      legalName: restaurantDataFromFE.legalName,
      companyType: restaurantDataFromFE.companyType,
      gstCertificate: restaurantDataFromFE.gst,
      fssaiCertificate: restaurantDataFromFE.fssai,
