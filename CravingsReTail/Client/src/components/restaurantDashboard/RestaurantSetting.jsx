  ...
  return (
    <>
      <div className=" h-full flex flex-col">
        <div className="border-b border-(--secondary)/50 flex justify-between mb-2 w-full">
          <div className="flex gap-3 ">
            {Tabs.map((tab, idx) => (
              <>
                <div
                  key={idx}
                  className={`p-2 uppercase cursor-pointer ${activeTab === tab.id ? "text-(--primary) border-b-3 border-(--primary)" : ""}`}
