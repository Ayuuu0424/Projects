        ...
        {isLoadingRestaurant ? (
          ...
          <>
            <div className="flex flex-col gap-2 h-full">
              ...
              {/* Social Media Links */}
              <div className="bg-(--base-100) rounded-lg p-3 h-full flex flex-col">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <button
                    ...
                    className="text-xs bg-(--primary) text-(--primary-content) px-2 py-0.5 rounded"
                  >
                    + Add Link
                  </button>
                </div>
                  ...
                  {restaurantFormData.socialMediaLinks.map((link, index) => (
                    ...
                    >
                      <input
                        ...
                        className={`w-full px-1.5 py-1 border border-(--secondary) ${editingRestaurant ? "bg-white" : "bg-(--base-100)"} rounded text-sm`}
                        disabled={!editingRestaurant}
                      />
